...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Fyrecart for wholesale tech enquiries and quotes.",
};
            ...
            <div>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"></textarea>
                </div>
                <button type="submit" className="w-full py-2.5 bg-yellow-600 text-white font-medium rounded-lg hover:bg-yellow-500">
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { t: "Email", v: "info@fyrecart.com", d: "Response within 24 hours" },
                    { t: "Address", v: "67 Aleksanterinkatu, Helsinki 00100", d: "Finland" },
                    { t: "Hours", v: "Monday - Friday", d: "9:00 AM - 6:00 PM EET" },
                  ].map((c, i) => (
                    <div key={i} className="p-4 bg-gray-50 rounded-lg">
                      <h3 className="font-semibold text-gray-900">{c.t}</h3>
                      <p className="text-yellow-600">{c.v}</p>
